...
/**
 */
export type ParamsBodycommonTaskAuditPageListTaskIdPageNumPageSizePost = 2;
/**
...
/**
 */
export type ParamsBodycommonTaskHistoryPageListTaskIdPageNumPageSizePost = any;
/**
 ...
 * 公共任务表
 */
export type ParamsBodycommonTaskPageListPageNumPageSizePost =
  models.CommonTask1;
/**
 * 公共任务
 */
...
/**
 */
export type ParamsBodycommonTaskPut = 1;
/**
 ...
 * 知识
 */
export type ParamsBodykmsZsbjServerApiKnowledgeAddPost = models.Knowledge1;
/**
...
/**
 */
export type ParamsBodyobjectCommonTaskObjectIdPut =
...
export class DefaultApi {
  ...
  public algorithmAddPost = (
    data: ParamsBodyalgorithmAddPost,
  ...
  public algorithmDeleteBatchDelete = (
    ...
    data: ParamsBodyalgorithmDeleteBatchDelete,
    opt?: ExtraFetchParams
  ): AjaxPromise<models.BaseResponse> => {
  ...
  public algorithmDeleteDelete = (
    ...
    data: ParamsBodyalgorithmDeleteDelete,
    opt?: ExtraFetchParams
  ): AjaxPromise<models.BaseResponse> => {
  ...
  public algorithmEditPost = (
    data: ParamsBodyalgorithmEditPost,
    opt?: ExtraFetchParams
  ): AjaxPromise<models.BaseResponse> => {
  ...
  public algorithmListPost = (
    ...
    data: ParamsBodyalgorithmListPost,
    opt?: ExtraFetchParams
  ...
  public commonTaskAuditPageListTaskIdPageNumPageSizePost = (
    ...
    data: ParamsBodycommonTaskAuditPageListTaskIdPageNumPageSizePost,
    opt?: ExtraFetchParams
  ): AjaxPromise<models.BaseResponseIPageCommonTaskAuditLog> => {
    const { pageNum, pageSize, taskId } = params;
    const url =
      this.$basePath +
      `/commonTask/audit/pageList/${taskId}/${pageNum}/${pageSize}`;
    const p: any = {};
  ...
  public commonTaskFlowTaskIdPut = (
    ...
    data: ParamsBodycommonTaskFlowTaskIdPut,
    opt?: ExtraFetchParams
  ): AjaxPromise<models.BaseResponse> => {
    const { taskId } = params;
  ...
  public commonTaskHistoryPageListTaskIdPageNumPageSizePost = (
    ...
    data: ParamsBodycommonTaskHistoryPageListTaskIdPageNumPageSizePost,
    opt?: ExtraFetchParams
  ): AjaxPromise<models.BaseResponseIPageCommonTaskVersion> => {
    const { pageNum, pageSize, taskId } = params;
    const url =
      this.$basePath +
      `/commonTask/history/pageList/${taskId}/${pageNum}/${pageSize}`;
    const p: any = {};
    ajax.check(params.pageNum, "pageNum");
    ajax.check(params.pageSize, "pageSize");
    ajax.check(params.taskId, "taskId");
  ...
  public commonTaskPageListPageNumPageSizePost = (
    ...
    data: ParamsBodycommonTaskPageListPageNumPageSizePost,
    opt?: ExtraFetchParams
  ...
  public commonTaskTaskIdDelete = (
    ...
    data: ParamsBodycommonTaskTaskIdDelete,
    opt?: ExtraFetchParams
  ): AjaxPromise<models.BaseResponse> => {
    const { taskId } = params;
  ...
  public objectCommonTaskObjectIdPut = (
    ...
    data: ParamsBodyobjectCommonTaskObjectIdPut,
    opt?: ExtraFetchParams
  ): AjaxPromise<models.BaseResponse> => {
    const { objectId } = params;
    const url = this.$basePath + `/objectCommonTask/${objectId}`;
